...
export default function PiperClubPage() {
  const [tab, setTab] = useState('info');

  return (
    <div className="p-4 bg-white text-black min-h-screen">
      <img src="/piper-club.jpg" alt="Piper Club" className="w-full h-60 object-cover mb-4 rounded-lg" />
      <h1 className="text-3xl font-bold">Piper Club</h1>
